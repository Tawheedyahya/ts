...
urlpatterns = [
    ...
    path("", views.admin_ticket_list, name="home"),  # or create a separate landing view

    path("admin/", admin.site.urls),

    # User auth for tickets
    path("user/login/", views.user_login, name="user_login"),
    path("superadmin/login/", views.superadmin_login, name="superadmin_login"),

    # Optional: keep old generic login for sales superadmin only
    path(
        "login/",
    ...
    # Ticket views
    path("tickets/my/", views.user_ticket_list, name="user_ticket_list"),
    path("tickets/all/", views.admin_ticket_list, name="admin_ticket_list"),
    ...
    path(
        "ticket/<int:ticket_id>/update_status/",
    ...
    path("sales-summary/<str:month_year>/", views.sales_summary_pdf, name="sales_summary_pdf"),
    path("send-whatsapp-api/", views.send_whatsapp_api, name="send_whatsapp_api"),
    path('superadmin/create-user/', views.create_normal_user, name='create_normal_user'),
    path('tickets/my/', views.user_ticket_list, name='user_ticket_list'),
    path('superadmin/users/', views.user_list, name='user_list'),
    path('superadmin/users/delete/<int:user_id>/', views.superadmin_delete_user, name='superadmin_delete_user'),    
